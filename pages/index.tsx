  ...
  return (
    <div style={{ position: "relative", overflow: "hidden" }}>
      ...
      >
        ...
        />
        <div className="index-sponsor" style={{zIndex:"1000"}}>아우토크립트 후원! 대박 감사!<br/>모빌리티의 중심 아우토크립트여 영원하라</div>
        <img src="static/AUTOCRYPT_Logo_Large_White.png" style={{objectFit: "contain", bottom:"2vh", height:"5vh", position:"absolute", zIndex:"1000"}}/>
